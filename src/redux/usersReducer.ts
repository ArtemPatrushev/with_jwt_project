...
// как типизировать - диспатчит action из другого reducer
...
// сделать общую функцию, которая будет обрабатывать запросы с токеном и вызывать нужные запросы из api
